...
function watu_questions() {
	...
	if(!empty($_GET['filter_answer_type'])) {
		if( !in_array($_GET['filter_answer_type'], array('radio', 'checkbox', 'textarea'))) $_GET['filter_answer_type'] = 'radio';
		$filter_sql .= $wpdb->prepare(" AND Q.answer_type = %s ", $_GET['filter_answer_type']);
	}		
