...
-- Sun 21 Oct 2018 02:06:25 PM CDT
...
BEGIN
	SELECT usuario.nombre, partida.idPartida, partida.nombre AS 'nombrePartida', limiteJugadores, jugadores, meta, fundador, montoInicial FROM usuario, partida WHERE partida.idPartida = _idPartida AND usuario.idPartida = _idPartida;
END$$
