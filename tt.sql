...
-- Thu 18 Oct 2018 02:30:47 AM CDT
...
BEGIN
	SELECT partida.idPartida, partida.nombre, limiteJugadores, jugadores, meta, fundador, montoInicial, usuario.nombre FROM usuario, partida WHERE partida.idPartida = _idPartida AND usuario.idPartida = _idPartida;
END$$
