...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  <div class="w3-container w3-row">
    ...
    <div class="w3-col s8 w3-bar">
      <span>Buen día, <strong id="mainName">Mike</strong></span><br>    <!--Agregar JS para obtener el nombre del usuario-->
      <button onclick="openLink(event, 'Configuracion')" class="w3-bar-item w3-button"><i class="fa fa-user"></i></button>
      <button onclick="openLink(event, 'Finanzas')" class="w3-bar-item w3-button"><i class="fa fa-cog"></i></button>
    </div>
  </div>
  <hr>
